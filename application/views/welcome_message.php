    ...
    <div class="row">
     <div class="control-label col-sm-5">
      ...
      <section>      
        ...
        echo form_open('welcome/send', $attributes);
    ...
    if(el.value=='') document.getElementById('cpfResponse').innerHTML = '';
          ...
          <div class="col-xs-8">
            <div class="form-inline">
              ...
              <div class="form-group">
                <a href="<?php echo base_url('index.php/admin/login'); ?>" class="btn btn-info" role="button">Se já possui Cadastro Clique Aqui</a>
              </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-3 col-sm-3">
           <h2>Preencha os dados dos responsáveis</h2>
          </div>
        </div>
	  ...
	  <div class="form-group">
          <label class="control-label col-sm-3">Força <span class="text-danger">*</span></label>
          <div class="col-xs-8">
            <div class="form-inline">
              <div class="form-group">
...
<!--
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-4">
            <input type="text" class="form-control" name="logradouro" id="mem_name" placeholder="Nome da Rua" value="" required="">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-3 col-sm-4">
            <input type="text" class="form-control" name="numero" id="mem_name" placeholder="00000" value="" required="">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-3 col-sm-4">
            <input type="text" class="form-control" name="bairro" id="mem_name" placeholder="Nome do seu Bairro" value="" required="">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-3 col-sm-4">
            <input type="text" class="form-control" name="cep" id="mem_name" placeholder="Seu Cep" value="">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-3 col-sm-4">
            <input type="text" class="form-control" name="complemento" id="mem_name" placeholder="Complemento" value="">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-3 col-sm-4">
            <input type="text" class="form-control" name="cidade" id="mem_name" placeholder="Cidade" value="" required="">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-4">
              ...
              <input type="email" class="form-control" name="email" id="emailid" placeholder="Seu E-mail@" value="" required="">
            </div>
            <small> Seu Email será mantido em sigilo. </small> </div>
        </div>

        <div class="form-group">
          <label class="control-label col-sm-3">Confirme seu E-mail <span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-4">
              <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
              <input type="email" class="form-control" name="email_confirm" id="emailid" placeholder="Seu E-mail@" value="" required="">
            </div>
            <small> Seu Email será mantido em sigilo. </small> </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            ...
            <input type="text" class="form-control" name="telefone_1" id="contactnum" placeholder="Entre com o número para contato" value="">
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
            <input type="text" class="form-control" name="telefone_2" id="contactnum" placeholder="Entre com o número para contato" value="" required="">
            </div>
          </div>
        </div>
