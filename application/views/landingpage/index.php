...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <section id="about" class="container content-section text-center">
        ...
        <form action="index.php/welcome/valida" method="POST">
			<h2>Concurso de Admissão ao CMCG2017/2018</h2>
            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <li class="text-left"><strong>24/07/2017</strong><a href="<?php echo base_url('150DECEX.PDF'); ?>"> -Portaria n° 150 do DECEx, de 10 de julho de 2017, que aprova as Instruções Reguladoras do Concurso de Admissão e da Matrícula nos Colégios Militares, referentes ao concurso de admissão para matrícula em 2018 (IRCAM/CM). </a></li>

                <li class="text-left"><a href="<?php echo base_url('149DECEX.pdf'); ?>"> Port 149 DECEx-IRCAM-CACM</a></li><br>

                <li class="text-left"><strong>CONCURSO DE ADMISSÃO CMCG 2017</strong></li>

                <li class="text-left"><strong>Vagas no CMCG:</strong> 10 (Dez) para o 6º Ano do Ensino Fundamental.</li>

                <li class="text-left"><strong>Valor da Taxa de Inscrição:</strong> R$ 95,00 (Noventa e Cinco reais)</li>

                <liclass="text-left"><strong>Extrato simplificado do Calendário:</strong></li>

             <div class="text-left"> - Processamento das inscrições: de 24 Jul a 28 Ago 17;<br>
              - Ambientação dos candidatos para o Exame Intelectual (EI): 9 Set 17;<br>
              - Realização do EI - prova de Matemática (6° ano/EF): 10 Set 17;<br>
              - Divulgação do resultado da prova de Matemática: 25 Set 17;<br>
              - Realização do EI - prova de Língua Portuguesa (6° ano/EF): 22 Out 17;<br>
              - Divulgação do resultado da prova de Língua Portuguesa: 20 Nov 17;<br> 
              - Divulgação das notas finais do EI e chamada para a realização de inspeção de saúde dos candidatos aprovados e classificados no EI: 04 Dez 17.</div><br>
            </ul>

       
		      <input type="checkbox" name="id" value="1" required="" /> Tenho conhecimento de todas as informações aqui citadas. <br>
           
           
            <button class="btn btn-info btn-lg"  class="btn btn-default" type="submit">REALIZAR INSCRIÇÂO</button>
        ...
        <div class="download-section">
            <div class="container">
                <div class="col-lg-8 col-lg-offset-2">
                    <h2></h2>
                    <p></p>
                    <a href="#" class="btn btn-default btn-lg">Conheça o Colégio Militar de Campo Grande</a>
                </div>
            </div>
        </div>
    </section>
